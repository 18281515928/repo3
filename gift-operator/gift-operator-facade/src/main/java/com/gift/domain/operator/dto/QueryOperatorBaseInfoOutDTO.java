 ...
 * @version 0.0.1
 * @className QueryoperatorBaseInfoOutDTO
 * @sine 2020/3/24 10:53
 */
@Data
public class QueryOperatorBaseInfoOutDTO implements Serializable {

    private static final long serialVersionUID = -4796402158725207269L;
    /**
     * 企业客户号
     */
