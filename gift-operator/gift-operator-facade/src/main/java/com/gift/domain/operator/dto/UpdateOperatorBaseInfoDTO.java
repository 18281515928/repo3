 ...
 * @version 0.0.1
 * @className UpdateoperatorBaseInfoDTO
 * @sine 2020/3/24 10:58
 */
@Data
public class UpdateOperatorBaseInfoDTO implements Serializable {


    private static final long serialVersionUID = -5563087925127977386L;
    /**
     * 企业客户号
     */
