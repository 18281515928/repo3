 ...
 * @version 0.0.1
 * @className Cuoperator
 * @sine 2020/3/24 15:00
 */
@Data
public class CuOperator implements Serializable {

    private static final long serialVersionUID = -8665693424025104874L;
    /**
     * 企业客户号
     */
